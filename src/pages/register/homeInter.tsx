// ================================================================
// HomeInter.tsx — Step 2: Pilih format kompetisi (International Citizen)
// ================================================================
...
const COMPETITION_OPTIONS = [
  {
    ...
    desc: "Participate remotely from anywhere in the world",
    icon: Monitor,
  },
  {
    value: "offline" as CompetitionType,
    label: "Offline Competition",
    desc: "Join us in-person at the event venue",
    icon: Users,
  },
];
  ...
  return (
    <div className="w-full max-w-2xl">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2 text-sm">International Citizen — select competition format</p>
      </div>
