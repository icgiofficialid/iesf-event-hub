...
const LABELS = {
  ...
  sub:   { en: "International Citizen — select format",          id: "Warga Internasional — pilih format kompetisi" },
...
const COMPETITION_OPTIONS = [
  {
    ...
    desc:  { en: "Participate remotely from anywhere in the world", id: "Ikuti kompetisi dari mana saja di dunia" },
    icon: Monitor,
  },
  {
    value: "offline" as CompetitionType,
    label: { en: "Offline Competition",                     id: "Kompetisi Offline" },
    desc:  { en: "Join us in-person at the event venue",    id: "Hadir langsung di lokasi acara" },
    icon: Users,
  },
];

const HomeInter = ({ competition, setCompetition, onBack, onNext }: Props) => {
  const { lang } = useLang();
  return (
